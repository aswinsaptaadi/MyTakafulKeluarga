...
import 'package:mytakafulkeluarga/Model/receive_notification_models.dart';
...
Future<void> showNotification() async {
  ...
  Future<void> scheduleDailyPrayerTime(int id, String title, String body, Time time) async {
    await flutterLocalNotificationsPlugin.zonedSchedule(
        id,
        title,
        body,
        _timePrayer(time.hour, time.minute),
        // const NotificationDetails(
        //   android: AndroidNotificationDetails('daily notification channel id',
        //       'daily notification channel name',
        //        'daily notification description'),
        ...
        const NotificationDetails(
          android: AndroidNotificationDetails(
            'Prayer Time IdDaily','Prayer Time Notification',
               'Prayer Time Notification Configuration',
  ...
  tz.TZDateTime _timePrayer(int hour, int minute) {
    final tz.TZDateTime now = tz.TZDateTime.now(tz.local);
    tz.TZDateTime scheduledDate =

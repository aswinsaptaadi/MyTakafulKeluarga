...
class ProductPersonalTakafulinkFalahProteksi extends StatefulWidget {
  @override
  _ProductPersonalTakafulinkFalahProteksiState createState() =>
      _ProductPersonalTakafulinkFalahProteksiState();
}

class _ProductPersonalTakafulinkFalahProteksiState
    extends State<ProductPersonalTakafulinkFalahProteksi> {
  sendMail() async {
...
//      ..bccRecipients.add(Address('bccAddress@example.com'))
      ..subject = 'Takaful Falah Proteksi ${DateTime.now()}'
      ..text = 'Takaful Keluarga - Takaful Falah Proteksi'
      ..html =
          "<h1>Takaful Keluarga</h1><p>Takaful Falah Proteksi</p>";
              ...
              Column(
                children: [
                  ...
                  RaisedButton(
                      ...
                      onPressed: () {
                        Navigator.pushNamed(context, RouteName.BookNowPageFalahProteksi);
                      }),
                  SizedBox(height: 30)
                ],
              ),

...
class BookNowPageZiarah extends StatefulWidget {
  @override
  _BookNowPageZiarahState createState() => _BookNowPageZiarahState();
}

class _BookNowPageZiarahState extends State<BookNowPageZiarah> {

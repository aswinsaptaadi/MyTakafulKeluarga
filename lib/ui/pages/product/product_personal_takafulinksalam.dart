...
class ProductPersonalTakafulinkSalam extends StatefulWidget {
  @override
  _ProductPersonalTakafulinkSalamState createState() =>
      _ProductPersonalTakafulinkSalamState();
}

class _ProductPersonalTakafulinkSalamState
    extends State<ProductPersonalTakafulinkSalam> {
  sendMail() async {
...
//      ..bccRecipients.add(Address('bccAddress@example.com'))
      ..subject = 'Takafulink Salam ${DateTime.now()}'
      ..text = 'Takafulink Salam.'
      ..html =
          "<h1>Takafulink Salam/h1>";
              ...
              Column(
                children: [
                  ...
                  CartList(
                    ...
                    place:
                        'Biaya kesehatan meliputi rawat inap, rawat jalan, rawat gigi, persalinan, ICU, serta pembedahan akan dibayarkan senilai dengan plan yang dipilih oleh peserta.',
                  ),
                  SizedBox(height: 10),
                  CartList(
                  ...
                  RaisedButton(
                      ...
                      onPressed: () {
                        Navigator.pushNamed(context, RouteName.BookNowPageSalam);
                      }),
                  SizedBox(height: 30)
                ],
              ),

...
class ProductPersonalTakafulinkSalamCommunity extends StatefulWidget {
  @override
  _ProductPersonalTakafulinkSalamCommunityState createState() =>
      _ProductPersonalTakafulinkSalamCommunityState();
}

class _ProductPersonalTakafulinkSalamCommunityState
    extends State<ProductPersonalTakafulinkSalamCommunity> {
  sendMail() async {
...
//      ..bccRecipients.add(Address('bccAddress@example.com'))
      ..subject = 'Takafulink Salam Community ${DateTime.now()}'
      ..text = 'Takaful Keluarga Takafulink Salam Community'
      ..html =
          "<h1>Takaful Keluarga</h1><p>Takafulink Salam Community</p>";
              ...
              Column(
                children: [
                  ...
                  CartList(
                    ...
                    place:
                        'Santunan rawat inap akan dibayarkan senilai dengan plan yang dipilih oleh peserta.',
                  ),
                  SizedBox(height: 10),
                  CartList(
                  ...
                  RaisedButton(
                      ...
                      onPressed: () {
                        Navigator.pushNamed(context, RouteName.BookNowPageSalamCommunity);
                        // print("CLIK");
                        // sendMail();
                        // context
                        // .bloc<PageBloc>()
